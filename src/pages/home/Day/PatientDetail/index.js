...
import { dayScreenPath, wsibform } from "../../../../routes/pathNames";
import { collection, getDocs, updateDoc, doc } from "firebase/firestore";
import { firestore } from "../../../../config/firebase";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import { fillWSIBForm } from "../../../../config/formHelper";
...
const AppointmentDetail = () => {
  ...
  useEffect(() => {
    const fetchedAppointment = appointmentData.appointments.find(
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              {appointment ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 ...
                 {
                  appointment.appointmentStatus!=="Cancelled" &&    <button
                  className="bg-blue-500 text-white py-2 px-4 rounded my-2 mb-5"
                ...
                >
                  Fill WSIB Form
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg shadow-inner">
                      <p className="mb-2">
                        <strong>Name:</strong> {appointment.appointmentName}
                      </p>
                      <p className="mb-2">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg shadow-inner">
                      <p className="mb-2">
                        ...
                        {appointment.doctor || "Dr. John Doe"}
                      </p>
                      <p className="mb-2">
                        <strong>Notes:</strong>{" "}
